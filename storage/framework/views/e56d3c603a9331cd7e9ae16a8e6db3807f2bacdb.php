...
<div class="container-fluid login-page">
    <h1 class="row justify-content-center" style="margin-bottom: 50px">Share and Help</h1>
                    ...
                    <form method="POST" action="<?php echo e(route('login')); ?>">
                        ...
                        <div class="form-group row mb-0">
                            <div class="col-md-8 offset-md-4">
                                ...
                                <a style="margin-left: 10px" class="btn-link" href="<?php echo e(route('password.request')); ?>">
